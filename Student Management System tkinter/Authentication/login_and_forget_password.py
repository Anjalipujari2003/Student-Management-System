...
class login_window:
    def __init__(self,root):
        ...
        img1=Image.open(r"./images/login-icon.jpg")
        ...
        loginbtn=Button(frame,text="Forgot Password",font=("times new roman",10,"bold"),command=self.forget_password,borderwidth=0,fg="white",bg="black",activeforeground="black",activebackground="white")
